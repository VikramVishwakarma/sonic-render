...
<section id="hero">
  <div class="container">
    ...
    <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center aos-init aos-animate" data-aos="fade-up">
    <div class="des">
          <h1>We are <span class="auto-input typed-text"></span></h1>
          <h3 class="mid-text">"Unleash Your Creativity with Sonic Render 3D Design! Dive into a world of boundless imagination and innovation"</h3>
          <h2>"Where Sonic Render empowers you to explore, create, and bring your wildest ideas to life in stunning three-dimensional detail."</h2>
          <a href="#about" class="btn-get-started scrollto">Get Started</a>
        </div>
        </div>
      <div class="col-lg-4 order-1 order-lg-2 hero-img" id="model1" data-aos="fade-left">
...
<div class="news-ticker">
  <div class="ticker-container">
    <div class="ticker-item">- 3D Models : Portray real-world and conceptual visuals for art, entertainment, simulation and drafting.</div>
    <div class="ticker-item">- 3D Characters : Creates a three-dimensional digital representation of a surface or an object.</div>
    <div class="ticker-item">- AR | VR | XR | MR : Real and/or virtual environments or interactions generated by tech.</div>
  ...
  <div class="container glass-effect"> <!-- Add the glass-effect class here -->
    ...
    <div class="col-lg-6" data-aos="zoom-in">
      <video class="video-fluid" autoplay loop muted>
        <source src="<?php echo get_template_directory_uri(); ?>/glitch.mp4" type="video/mp4">
